...
from os import getcwd, chdir, makedirs, mkdir
...
dirName = "cellCollection"
CELL_COLLECTION_DIR = join(saveDir, dirName)
...
class cellPallate:
	...
	def saveCell(self, cellObj, name):
		...
		try:
			...
			self.g.show('cell with name "' + name + '" already exists. Save was not successful.')
